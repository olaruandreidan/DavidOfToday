...
export function QuestionFlow({ questions, index, answers, onAnswer, onIndex, onSubmit, busy, submitLabel, answerHint }: {
  ...
  return <div className="card">
    ...
    <label htmlFor="reflection-answer" className="font-display text-2xl font-bold leading-snug">{question.text}</label>{answerHint && <p className="mt-3 text-sm text-ink/55">{answerHint}</p>}
